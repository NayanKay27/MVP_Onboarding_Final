...
using OnBoarding_Project.Models.ViewModels;
using System.Data;
...
namespace OnBoarding_Project.Controllers
{
    ...
    public class SalesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Sales>>> GetSales()
        {
            ...
            /*var sales = _context.Sales.Include(sale => sale.Customer)
                .Include(sale => sale.Product)
                .Include(sale => sale.Store).Select(s => new SalesViewModel
                {
            ...
            /*return await _context.Sales.Include(s => s.Customer).Include(s => s.Product).Include(s => s.Store)
